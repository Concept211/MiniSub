    ...
    */
	...
	$('table.songlist tr.song td.artist a').live('click', function (event) {
        ...
        if (artistid !== "undefined") {
            ...
            getMusicDirectory(artistid, 'link', '#AlbumContainer tbody', artistid);
        }
        return false;
    });
    ...
    $('#action_Preview').click(function () {
        ...
        if (getCookie('Preview')) {
			...
			$('.fullsection').animate({width: '100%'});
			$('.previewsection').animate({width: '0%'});
        }
		else {
			...
			$('.fullsection').animate({width: '70%'});
			$('.previewsection').animate({width: '30%'});
        }
...
/*
    ...
    $("a#coverartimage, a#preview_coverartimage").fancybox({
        beforeShow : function() {
